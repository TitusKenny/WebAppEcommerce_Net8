...
namespace WebAppEcommerce_Net8.Controllers
{
    ...
    {
        private readonly WebAppShopNet8Context _context;

        public HangHoasController(WebAppShopNet8Context context)
        {
            _context = context;
        }
        ...
        {
            var webAppShopNet8Context = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await webAppShopNet8Context.ToListAsync());
        }
